...
//        }
    	 ...
    	 stockProfile currentStock = searchAvailableStock(stockName);
    	    if (currentStock != null) {
    	        double currentPrice = currentStock.getSellPrice();

    	        if (quantity <= profile.getQuantity()) {
    	            double price = currentPrice * quantity; // Use the updated current price
    	            accProfile.setBalance(+price);
    	        ...
    	        JOptionPane.showMessageDialog(null, "Error Fetching Current Stock Price", "Error",
    	                JOptionPane.WARNING_MESSAGE);
    	    }
